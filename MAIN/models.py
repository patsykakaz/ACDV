...
class Univers(Page, RichText):
        small_cover = models.ImageField(upload_to=MEDIA_ROOT+'/univers/small_cover', verbose_name="Image représentant l'univers sur la page d'accueil",help_text="Taille recommandée: 800x450; Poinds maximal recommandé: 90 Ko")
        full_cover = models.ImageField(upload_to=MEDIA_ROOT+'/univers/full_cover', verbose_name="Image représentant l'univers sur la page Univers",help_text="Taille recommandée: 1600px de large; Poids maximal recommandé: 180Ko")
...
class Revue(Page):
        master = models.ForeignKey(Univers, verbose_name='Filière de la revue')
        couverture = models.ImageField(upload_to=MEDIA_ROOT+'/couvertures', verbose_name='Couverture de la revue',help_text='Taille recommandée : 300px de large; Poids maximal recommandé : 80 Ko ')
        # OPTION_FILIERE = (
        #       ('TABAC','TABAC'),
        #       ('CHR-CHD','CHR-CHD'),
        ...
        site_web = models.URLField(verbose_name='site web',default='',blank=True,null=True,help_text='Effacez la valeur "False" en l\'absence d\'URL')
